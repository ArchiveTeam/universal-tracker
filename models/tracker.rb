...
module UniversalTracker
  class Tracker
    ...
    def destroy
      keys = %w{ tracker_admins log out downloader_count todo done blocked items_done_chartdata claims downloader_version downloader_bytes downloader_budget requests_per_minute min_downloader_budget }.map{|k| "#{ prefix }#{ k }" }
